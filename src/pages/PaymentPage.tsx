...
const VisaLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 211 68" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M82.3 14.5h16.5l-13.2 39h-11.1L63.9 25.1c-.8-1.6-1.5-2.2-3.9-2.8-3.9-1-10.1-2-15.6-2.5l-.3-5.3h27c3.4 0 6.5 2.3 7.3 6.2l6.6 35.2L98.2 14.5zm50.3 26.4c.1-10.3-14.3-10.9-14.2-15.5.1-1.4 1.3-2.9 4.2-3.2 1.4-.2 5.3-.3 9.8 1.7l1.7-8c-2.4-.9-5.5-1.7-9.4-1.7-9.9 0-16.9 5.3-17 12.8-.1 5.6 5 8.7 8.8 10.5 3.9 1.9 5.2 3.1 5.2 4.8-.1 2.5-3 3.6-5.8 3.7-4.9.1-7.7-1.3-10-2.4l-1.8 8.3c2.3 1.1 6.5 2 10.9 2.1 10.5 0 17.4-5.2 17.5-13.3zm25.1 12.6h9.7l-8.5-39h-9c-2.8 0-5.2 1.6-6.3 4.1l-22.2 34.9h10.5l2.1-5.8h12.9l1.2 5.8zm-11.2-14.3l5.3-14.6 3 14.6h-8.3zm-46.6-24.7l-8.3 39h10l8.3-39h-10z" fill="#1A1F71"/>
  </svg>
);
